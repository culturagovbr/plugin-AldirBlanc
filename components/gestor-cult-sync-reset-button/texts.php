...
return [
    'buttonLabel' => i::__('Habilitar Sync'),
    ...
    'confirmModalCancel' => i::__('Cancelar'),
    'confirmModalConfirm' => i::__('Confirmar e habilitar'),
    'verifyingRestrictions' => i::__('Verificando Restrições'),
    'clearingUserCache' => i::__('Limpando Cache do usuário'),
    'clearingMetadata' => i::__('Limpando Metadados'),
    'enablingSync' => i::__('Habilitando Sync...'),
    'errorGeneric' => i::__('Não foi possível concluir.'),
    'networkError' => i::__('Erro de rede.'),
    'invalidUserId' => i::__('Identificador de usuário inválido.'),
];
